...
function CreateRegoc(){
    ...
    const submitForm = async(e) =>{
        ...
        try {
            ...
            const endpoint = import.meta.env.VITE_ALL_RECOGNIZED;
    ...
    return(
        <div className="mt-24 flex justify-center">
            <div className="w-4/5 flex-col">
                <h1 className="text-black text-2xl font-bold">Crear raza reconocida</h1>
